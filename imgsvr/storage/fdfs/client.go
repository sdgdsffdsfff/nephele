...
func (this *FdfsClient) DownloadToFileByOffset(localFilename string, remoteFileId string, offset int64, downloadSize int64) (*DownloadFileResponse, error) {
	tmp, err := splitRemoteFileId(remoteFileId)
	if err != nil || len(tmp) != 2 {
		return nil, err
	}
...
func (this *FdfsClient) DownloadToFile(localFilename string, remoteFileId string) (*DownloadFileResponse, error) {
	return this.DownloadToFileByOffset(localFilename, remoteFileId, 0, 0)
}

func (this *FdfsClient) DownloadToBufferByOffset(remoteFileId string, offset int64, downloadSize int64) (*DownloadFileResponse, error) {
	tmp, err := splitRemoteFileId(remoteFileId)
	if err != nil || len(tmp) != 2 {
		return nil, err
	}
...
func (this *FdfsClient) DownloadToBuffer(remoteFileId string) (*DownloadFileResponse, error) {
	return this.DownloadToBufferByOffset(remoteFileId, 0, 0)
}
